        ...
        <motion.div className="bg-[#5352ED] min-h-[100vh] lg:overflow-y-hidden lg:h-[100vh]" exit={{opacity: 0, transition: {duration: 0.6, delay: 0.8}}}>
            <div className="bg-[#5352ED] min-h-[100vh] container mx-auto">
                ...
                <section className="px-[25px] lg:px-[50px] mt-[50px] text-center lg:text-left pb-[40px] flex flex-col lg:flex-row lg:justify-between ">
                    <div>
                        <motion.p initial={{opacity:0}} animate={{opacity:1}} exit={{opacity: 0, y: 80, transition: {duration: 0.6, delay: 0.2}}} transition={{delay:1.6}} className="text-center lg:text-left text-[45px] lg:text-[50px] xl:text-[68px] 2xl:text-[79px] lg:leading-[1.85] xl:leading-[1.75] 2xl:leading-[1.66] font-black text-white latoFamily max-w-[345px] lg:max-w-[470px] xl:max-w-[560px] mx-auto lg:mx-[0]">The online notepad for all your devices</motion.p>
                        <motion.p initial={{opacity:0}} animate={{opacity:1}} exit={{opacity: 0, y: 80, transition: {duration: 0.6, delay: 0.2}}} transition={{delay:2.4}} className="text-center lg:text-left text-white text-[18px] lg:text-[22px]  mt-[20px] lg:mt-[35px] xl:mt-[30px] 2xl:mt-[20px] max-w-[585px] lg:max-w-[470px] xl:max-w-[560px] mx-auto lg:mx-[0]">You don’t need a different notepad app for your phone, tablet, and laptop, just use Notely!</motion.p>
                        <motion.button initial={{opacity:0}} animate={{opacity:1}} exit={{opacity: 0, y: 80, transition: {duration: 0.6, delay: 0.2}}} transition={{delay:5}} className="text-[22px] text-[#474956] bg-white py-[14px] px-[67px] lg:px-[100px] rounded-[18px] mt-[35px] lg:mt-[50px] xl:mt-[55px] 2xl:mt-[40px] z-30 getStartedButton hover:scale-95" onClick={() => history.push('/signUp')}>Get started</motion.button>
                    </div>
                    <motion.img initial={{opacity:0, scale: 0.8, y: 50}} animate={{opacity:1, scale: 1, y: 0}} exit={{opacity: 0, y: 80, transition: {duration: 0.6, delay: 0.2}}} transition={{delay:4}} src={sally} className="relative w-full max-w-[450px] lg:max-w-[540px] lg:bottom-[10px] xl:max-w-[690px] xl:bottom-[100px] mx-auto lg:mx-[0]" />
                </section>
            </div>
