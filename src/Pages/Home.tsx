            ...
            <div className="bg-[#5352ED] min-h-[100vh] container mx-auto">
                ...
                <section className="px-[25px] lg:px-[50px] mt-[50px] text-center lg:text-left pb-[40px] flex flex-col lg:flex-row lg:justify-between ">
                    <div>
                        ...
                        <motion.button initial={{opacity:0}} animate={{opacity:1}} exit={{opacity: 0, y: 80, transition: {duration: 0.6, delay: 0.2}}} transition={{delay:5}} className="text-[22px] text-[#474956] bg-white py-[14px] px-[67px] lg:px-[100px] rounded-[18px] mt-[35px] lg:mt-[50px] xl:mt-[55px] 2xl:mt-[40px] z-30" onClick={() => history.push('/signUp')}>Get started</motion.button>
                    </div>
